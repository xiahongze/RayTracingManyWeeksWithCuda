...
public:
    ...
    __device__ ray get_ray(int i, int j, int s_i, int s_j, float recip_sqrt_spp, curandState *local_rand_state) const;

    __device__ vec3 pixel_sample_square(int s_i, int s_j, float recip_sqrt_spp, curandState *local_rand_state) const;
